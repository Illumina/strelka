...
\paragraph{Soft-clipped segment handling}
...
\paragraph{Creation of a representative alignment}
...
%    A site basecall could be incorrect because of sequencing error or because its read was incorrectly mapped to the genome. To account for this the model uses a mapped basecall error of
%    e_(b’)=(1-e_m ) e_b+e_m 3/4
...
% NOTE this needs to move to a somatic/germline shared section
