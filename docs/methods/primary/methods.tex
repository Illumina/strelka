...
\begin{equation*}
P(error) = \gamma(k,\lambda) / \Gamma(k)
\end{equation*}

...where $\gamma$ refers to the lower incomplete gamma function, $\lambda = e N_t$ and $k = N_a$. This error probability is provided in the output for each alternate allele as a phred-scaled quality score.
