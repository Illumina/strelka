...
\begin{equation*}
P(F_t, F_n \mid G_t = \texttt{som}, G_n, \text{NQSS})=j
\begin{cases}
...
Strelka defines an active region around dense variants and infer 2 haplotypes for the region. Using this we can phase proximal SNVs and indels. If two variants are lying on the same haplotype, we call they are in phase and the vice versa. 
