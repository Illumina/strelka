...
\item \texttt{VariantAlleleQuality} ~ The model-based variant quality value, reflecting the confidence that the called variant is present in at least one sample, regardless of genotype.
