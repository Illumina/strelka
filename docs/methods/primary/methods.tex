...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \texttt{NormalizedAltHaplotypeCountRatio}
    \end{itemize}
    \item RNA-seq SNV features not listed above:
    \begin{itemize}
        \item \texttt{SiteHomopolymerLength}
        \item \texttt{SampleStrandBias}
        ...
        \item \texttt{SamplePrimaryAltAlleleDepthFraction}
    \end{itemize}
    \item RNA-seq Indel features not listed above:
    \begin{itemize}
        ...
        \item \texttt{SamplePrimaryAltAlleleDepthFraction}
    \end{itemize}
    \item Somatic Indel features: [TODO: change on renaming]
    \begin{itemize}
        \item \texttt{QSI\_NT} 
        \item \texttt{ABS\_T\_RR} 
        \item \texttt{ABS\_T\_SOR} 
        \item \texttt{IC} 
        \item \texttt{IHP} 
        \item \texttt{RC} 
        \item \texttt{RU\_LEN} 
...
[TODO: add somatic. Also, anything to add for RNA-seq?]
\begin{itemize}
