...
\item \texttt{ContextCompressability} ~ The length of the upstream or downstream reference context (whichever is greater) that can be represented using 5 Ziv-Lempel keywords (see http://www.lptmc.jussieu.fr/user/lesne/PRE-Short.pdf, and Ziv & Lempel 1977 as cited there). The Ziv-Lempel keywords are obtained using the scheme of Ziv & Lempel 1977, by traversing the sequence and successively selecting the shortest subsequence that has not yet been encountered.
