...
\todo[inline]{Sangtae: Detail on which reads go into the assembly process?}

\todo[inline]{Xiaoyu: Update assembler description below to reflect older version that is in Strelka?}
