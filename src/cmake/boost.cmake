...
macro(static_find_boost boost_version boost_components)
    ...
    # THIS uses the static boost build... assuming pthread is not required in this case, but keeping check code around in case:
    #
    # pthread library required by boost
#    static_find_library(PTHREAD "pthread.h" pthread)
#    if    (HAVE_PTHREAD)
#        set  (THIS_ADDITIONAL_LIB ${THIS_ADDITIONAL_LIB} pthread)
