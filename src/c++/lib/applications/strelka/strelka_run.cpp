    ...
    const strelka_options& opt)
{
    ...
    bool noRequireNormalized(false);

    registerVcfList(opt.input_candidate_indel_vcf, INPUT_TYPE::CANDIDATE_INDELS, tumorReadHeader, streamData);
    registerVcfList(opt.input_candidate_indel_vcf_no_error, INPUT_TYPE::CANDIDATE_INDELS, tumorReadHeader,
    ...
    registerVcfList(opt.force_output_vcf_no_error, INPUT_TYPE::FORCED_GT_VARIANTS, tumorReadHeader,
                    streamData, noRequireNormalized);
