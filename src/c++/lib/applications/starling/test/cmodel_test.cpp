...
BOOST_AUTO_TEST_CASE( test_cmodel_gqx )
{
    ...
    dindel.ploidy=2;dindel.max_gt=STAR_DIINDEL::HET;dindel.indel_qphred=219;dindel.max_gt_qphred=219;dindel.max_gt_poly=2;dindel.max_gt_poly_qphred=236;dindel.is_forced_output=0;dindel.is_zero_coverage=0;
    std::initializer_list<double> init({1.34748e-22,2.59853e-24,1});
    std::copy(init.begin(), init.end(), dindel.pprob);
    
    starling_indel_report_info iri;
    iri.desc="4I";iri.ref_seq="----";iri.indel_seq="AATA";iri.vcf_ref_seq="C";iri.vcf_indel_seq="CAATA";iri.ref_upstream="CTGTCTCTAC";iri.ref_downstream="AATAAATAAA";iri.repeat_unit="AATA";iri.ref_repeat_count=11;iri.indel_repeat_count=12;iri.ihpol=5;iri.it=INDEL::INSERT;
    starling_indel_sample_report_info isri;
    isri.n_q30_ref_reads=1;isri.n_q30_indel_reads=6;isri.n_q30_alt_reads=4;isri.n_other_reads=17;isri.depth=28;
    ...
    dindel2.ploidy=2;dindel2.max_gt=STAR_DIINDEL::HET;dindel2.indel_qphred=120;dindel2.max_gt_qphred=120;dindel2.max_gt_poly=2;dindel2.max_gt_poly_qphred=163;dindel2.is_forced_output=0;dindel2.is_zero_coverage=0;
    ...
    iri2.desc="8I";iri2.ref_seq="--------";iri2.indel_seq="AATAAATA";iri2.vcf_ref_seq="C";iri2.vcf_indel_seq="CAATAAATA";iri2.ref_upstream="CTGTCTCTAC";iri2.ref_downstream="AATAAATAAA";iri2.repeat_unit="AATA";iri2.ref_repeat_count=11;iri2.indel_repeat_count=13;iri2.ihpol=5;iri2.it=INDEL::INSERT;
    
    starling_indel_sample_report_info isri2;
    isri2.n_q30_ref_reads=1;isri2.n_q30_indel_reads=4;isri2.n_q30_alt_reads=6;isri2.n_other_reads=17;isri2.depth=28;
