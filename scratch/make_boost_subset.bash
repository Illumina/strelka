...
for f in asio chrono function_types fusion geometry gil graph interprocess mpl numeric phoenix polygon preprocessor proto python signals signals2 spirit typeof units wave; do
