...
for f in asio chrono function_types geometry gil graph interprocess mpl numeric phoenix polygon preprocessor proto python signals signals2 spirit typeof wave; do
