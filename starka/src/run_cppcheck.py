...
# if cppcheck is found, run it on all c++ and return an error
# for any non-supressed warning message:
...
def usage() :
    ...
    run cppcheck on starka c++ source code, return error for any unsupressed cppcheck issue
